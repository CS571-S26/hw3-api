...
import { CS571DefaultSecretConfig, CS571Initializer, CS571InitOptions } from '@cs571/api-framework'
...
const appBundle = CS571Initializer.init(app, new CS571InitOptions());
